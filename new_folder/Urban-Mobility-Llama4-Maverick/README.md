# Urban Mobility AI - LLaMA-4-Maverick-17B

Production-style implementation of the **Urban Mobility AI: An LLM-Based Framework for Explainable and Actionable Transportation Intelligence in Smart Cities** pipeline using `meta-llama/Llama-4-Maverick-17B-128E-Instruct`.
...
48+ GB VRAM recommended for quantized local inference.
