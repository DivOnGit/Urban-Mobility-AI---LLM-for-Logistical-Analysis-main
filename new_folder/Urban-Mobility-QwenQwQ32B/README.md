# Urban Mobility AI - Qwen-QwQ-32B

Production-style implementation of the **Urban Mobility AI: An LLM-Based Framework for Explainable and Actionable Transportation Intelligence in Smart Cities** pipeline using `Qwen/QwQ-32B`.
...
48+ GB VRAM recommended for 4-bit inference; multi-GPU preferred.
