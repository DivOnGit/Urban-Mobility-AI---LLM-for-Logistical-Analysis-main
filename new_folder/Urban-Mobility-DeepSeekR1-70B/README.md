# Urban Mobility AI - DeepSeek-R1-Distill-LLaMA-70B

Production-style implementation of the **Urban Mobility AI: An LLM-Based Framework for Explainable and Actionable Transportation Intelligence in Smart Cities** pipeline using `deepseek-ai/DeepSeek-R1-Distill-Llama-70B`.
...
80+ GB VRAM or multi-GPU inference recommended.
